...
Each time you start a new forecasting project, you first need to create a folder to hold the output files generated by Amazon Forecast.   You are normally free to choose any name for a forecast folder.   For this workshop however, please use the folder names designated below. 
